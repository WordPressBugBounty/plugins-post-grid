...
{
  $elements_group['wishlist']['items']['yith_add_to_wishlist'] = array('name' => esc_html__('YITH - Add to Wishlist', 'post-grid'));
...
?>
  <div class="item">
    <div class="element-title header ">
      ...
      <span class="expand"><?php echo esc_html__('YITH - Wishlist', 'post-grid'); ?></span>
    </div>
